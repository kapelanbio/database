...
public abstract class CirculatingItemImpl extends ItemImpl implements CirculatingItem {
	...
	/**
	 * The default value of the '{@link #getCopies() <em>Copies</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getCopies()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getBorrowers() <em>Borrowers</em>}' reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getBorrowers()
	 * @generated NOT
	 * @ordered
	 */
	@ManyToMany(targetEntity = BorrowerImpl.class)
